...
public final class MathBracketsExpression extends MathExpression {
    // Instance Fields
    private MathExpression expression;

    // New Instance Method
    public static MathBracketsExpression newInstance(MathExpression expression) {
        return new MathBracketsExpression(expression);
    }

    // Constructor Method
    private MathBracketsExpression(MathExpression expression) {
        super();
