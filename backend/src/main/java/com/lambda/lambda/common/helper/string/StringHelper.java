...
import com.lambda.lambda.common.util.string.StringSet;
...
public final class StringHelper {
    /**
     * Appends an object to a String Builder
     */
    public static void appendText(StringBuilder builder, Object text) {
        builder.append(text + "");
    }
